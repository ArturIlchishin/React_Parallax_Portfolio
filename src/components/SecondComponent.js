                ...
                <div className={'main-article__grid'}>
                    ...
                    <div className={'main__article-exp'}>
                        ...
                        <div className={'main__article-workplace'}>
                            ...
                            <p className={'main__article__tasks'}>В данный момент работаю над стартапом tglead.com ( он на начальной стадии разработки ). Задачи - выбор библиотеки дизайна, дальнейшая работа с библиотекой ant design, работа с Redux Toolkit, таблицы, базовые задачи по верстке.
                            </p>
                        </div>
